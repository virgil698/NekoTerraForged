...
public abstract class ContinentGenerator implements SimpleContinent {
    ...
    public ContinentGenerator(Seed seed, GeneratorContext context) {
        int tectonicScale = context.settings.continentScale * 4;
        this.continentScale = context.settings.continentScale / 2;
        this.seed = seed.next();
        this.distanceFunc = context.settings.continentShape;
        this.shallowOcean = context.settings.shallowOcean;
        this.nearInland = context.settings.nearInland;
        this.frequency = 1.0F / tectonicScale;
        this.clampMin = 0.2F;
        this.clampMax = 1.0F;
        this.clampRange = this.clampMax - this.clampMin;
        this.offsetAlpha = context.settings.continentJitter;
        ...
        Noise shape = Noises.simplex(seed.next(), context.settings.continentScale * 2, 1);
