...
public class Perlin implements Noise {
    ...
    public static float sample(float x, float y, int seed, Interpolation interpolation) {
        ...
        float xd2 = xd0 - 1.0F;
        float yd2 = yd0 - 1.0F;
        float xf0 = NoiseUtil.lerp(
            NoiseUtil.gradCoord2D(seed, x2, y2, xd0, yd0),
            NoiseUtil.gradCoord2D(seed, x3, y2, xd2, yd0), xs);
        float xf2 = NoiseUtil.lerp(
            NoiseUtil.gradCoord2D(seed, x2, y3, xd0, yd2),
            NoiseUtil.gradCoord2D(seed, x3, y3, xd2, yd2), xs);
