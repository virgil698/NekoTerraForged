...
public class Island {
    ...
    public Island(int id, Segment[] segments, WorldSettings settings, float deepOcean, float shallowOcean, float coast, float inland) {
        this(id, segments, deepOcean, shallowOcean, coast, inland);
    }

    public Island(int id, Segment[] segments, float deepOcean, float shallowOcean, float coast, float inland) {
        float x = 0.0F;
        float y = 0.0F;
